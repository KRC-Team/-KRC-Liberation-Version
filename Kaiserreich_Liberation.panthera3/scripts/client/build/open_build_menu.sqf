		...
		lbClear 110;
		{
			...
			if (buildtype != 8) then {
				...
				switch (_classnamevar) do {
					...
					case (Respawn_truck_typename select 0): {if (KP_liberation_mobilerespawn) then {_entrytext = localize "STR_RESPAWN_TRUCK";};};
					case (Respawn_truck_typename select 1): {if (KP_liberation_mobilerespawn) then {_entrytext = localize "STR_RESPAWN_TRUCK";};};
					case (Respawn_truck_typename select 2): {if (KP_liberation_mobilerespawn) then {_entrytext = localize "STR_RESPAWN_TRUCK";};};
					case (Respawn_truck_typename select 3): {if (KP_liberation_mobilerespawn) then {_entrytext = localize "STR_RESPAWN_TRUCK";};};
